...
\caption{PL relations for $J\!H\!K_s$, [3.6], and [4.5] photometry assuming [Fe/H]$=-1.567$. Here circles represent RRab stars, triangles represent RRcs, colored points are the final consistent sample with photometry in all 5 wavebands, grey points are stars that did not appear in all bands, and the unfilled points are stars rejected from the final sample based on $2\sigma$ clipping of the residuals of [3.6] vs. the residuals of $H$ and $K$.}

...
The average magnitudes presented in Table~\ref{tab:everything} are flux averages, and the photometric uncertainties of the time series data are the error on the mean. {\bf \textcolor{magenta}{I commented out the bit about gloess fitting - it didn't seem to fit.}}

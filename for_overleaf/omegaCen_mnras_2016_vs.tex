...
%Here the scatter contributed by metallicity itself is also less than or equal to the astrophysical scatter; $\sigma_{\text{[Fe/H]}} \leq \sigma_\text{astro}$.
...
\begin{figure*}
\begin{center}
\includegraphics[width=120mm]{dispersion_drawing.pdf}

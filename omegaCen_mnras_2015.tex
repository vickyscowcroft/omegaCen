...
% We average these distance moduli (thus essentially averaging the metallicities as well) to find a true mean distance modulus of $\mu_0 = 13.728 \pm 0.037$, which is in excellent agreement with prior measurements using near--infrared RRL period--luminosity relations \citep{2006ApJ...652..362D}, slightly higher than the distance modulus measured using the eclipsing binary OGLEGC17 \citep{2001AJ....121.3089T}, and significantly higher than the distance moduli measured by dynamical modelling \citep{2006A&A...445..513V,2013MNRAS.436.2598W}.

...
%The anomalously high distance modulus for 4.5~$\mu$m in Figure~\ref{fig:omegaCen_dist_m4_mean} is caused exclusively by the RRc stars, which have the lowest signal-to-noise measurements and are therefore most vulnerable to crowding effects. 

...
\caption{A $K_s$--band image of $\omega$~Cen from the FourStar camera, overlaid with the catalog of RR Lyrae \citep{2004A&A...424.1101K} and footprints of the three IRAC fields.}
\label{fig:omegaCen_fields}
\end{center}
\end{figure}

The primary limiting factor in this data is crowding: 77 RR Lyrae variables out of the original catalog of 192 \citep{2004A&A...424.1101K} were rejected due to crowding. We compared the {\it Spitzer} images to a $K_s$--band image from the FourStar infrared camera on Magellan \citep{2013PASP..125..654P}, with a resolution of 0.159 arcsec. This enabled us to see which stars were significantly contaminated. 
...
The theoretical RRL PL relations for each adopted average metallicity are shown in Figures~\ref{fig:omegaCen_pl_phot}  and \ref{fig:omegaCen_pl_spect} and described in Table~\ref{tab:pl_table_theo}. The relations take the form
...
We also use empirical PL relations derived from photometry of RR Lyrae variables in the globular cluster M4 (NGC 6121) from \citet{2015arXiv150507858N} for comparison.

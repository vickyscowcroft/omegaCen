...
\pubyear{2015}
% originally published on https://astronomersfittinglinestothings.tumblr.com/
...
\tablecaption{Mid--IR RR Lyrae period--luminosity relations for $\omega$ Cen.}
\label{tab:pl_table}
\tablehead{\colhead{Band}          &
           \colhead{Mode}  &
           \colhead{[Fe/H]}  &
           \colhead{$a$}   &
           \colhead{$b$}   &
...
\tablecolumns{19} 
\tablewidth{0pt} 
\tablecaption{$J\!H\!K$, 3.6~$\mu$m, and 4.5~$\mu$m photometry}
\label{tab:phot}
\rotate
\tablehead{\colhead{ID}          &
           \colhead{RA (J2000)}  &
           ...
           \colhead{Mode} &
           \colhead{[Fe/H], p}   &
           \colhead{$\sigma_{[\text{Fe/H}]}$, p}   &
           \colhead{[Fe/H], s}   &
           \colhead{$\sigma_{[\text{Fe/H}]}$, s} 
           }
\startdata
